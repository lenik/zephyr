...
BuildRequires:  gnu-smalltalk
BuildRequires:  gettext
BuildRequires:  asciidoctor

Requires:       gnu-smalltalk

%description
zephyr is a template repository for small Smalltalk command-line utilities.
It currently ships the some_puff1 example application and Debian packaging
metadata, and includes Smalltalk-based smoke/unit-test integration.
