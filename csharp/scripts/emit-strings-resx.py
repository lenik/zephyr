#!/usr/bin/env python3
# Regenerate apps/some_puff1/Resources/Strings*.resx from the tables below. Run if UI strings change.
import os
import xml.sax.saxutils as x

OUT = os.path.join(os.path.dirname(__file__), "..", "apps", "some_puff1", "Resources")
...
S_EN: dict[str, str] = {
    "Help_Usage": "Usage: some_puff1 [OPTION]... [FILE]...\n",
...
LANGS: dict[str, dict[str, str]] = {
    "de": {
        "Help_Usage": "Verwendung: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "fr": {
        "Help_Usage": "Utilisation : some_puff1 [OPTION]... [FILE]...\n",
    ...
    "it": {
        "Help_Usage": "Uso: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "ja": {
        "Help_Usage": "使い方: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "ko": {
        "Help_Usage": "사용법: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "zh-Hans": {
        "Help_Usage": "用法：some_puff1 [选项]... [文件]...\n",
    ...
    "zh-Hant": {
        "Help_Usage": "用法：some_puff1 [選項]... [檔案]...\n",
    ...
    "th": {
        "Help_Usage": "การใช้งาน: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "vi": {
        "Help_Usage": "Cách dùng: some_puff1 [OPTION]... [FILE]...\n",
    ...
    "eo": {
        "Help_Usage": "Uzo: some_puff1 [OPTION]... [FILE]...\n",
