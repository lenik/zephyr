...
document.getElementById('refresh').addEventListener('click', () => loadData(STATE.ui_lang));
...
loadData(new URLSearchParams(location.search).get('lang') || 'en');
