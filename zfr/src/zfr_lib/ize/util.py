...
SCAFFOLD = (
    ...
    "packaging/README.md",
    "packaging/lib/host.sh",
    "packaging/lib/common.mk",
    "packaging/rpm/Makefile",
    "packaging/rpm/.gitignore",
    "packaging/win32/Makefile",
    "packaging/win32/README.md",
    "packaging/win32/.gitignore",
    "packaging/win32/build-host.example",
    "packaging/win32/mingw/Makefile",
    "packaging/win32/mingw/meson-cross.ini",
    "packaging/win32/innosetup/Makefile",
    "packaging/win32/innosetup/setup.iss",
    "packaging/win32/innosetup/build.cmd",
    "packaging/win32/innosetup/build.ps1",
    "packaging/win32/wix/Makefile",
    "packaging/win32/wix/product.wxs",
    "packaging/win32/wix/build.cmd",
    "packaging/win32/wix/build.ps1",
    "packaging/macos/Makefile",
