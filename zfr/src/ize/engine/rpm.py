...
from lib import pkgdatadir, template_dir
...
def ensure_rpm_spec(ize: "Ize") -> None:
    from pkgfields import migrate_legacy_rpm_dir, resolve_rpm_dir, rpm_dir
    ...
    if not makefile_dest.is_file():
        ...
        if src is None:
            ...
            # Checkout: zfr/src/ize/engine/rpm.py → monorepo (parent of zfr/).
            # Installed: share/zephyr/zfr/ize/engine/rpm.py → share/zephyr.
