...
class FdmHtmlTests(unittest.TestCase):
    def test_ordered_channels(self) -> None:
        from fdm import encode_run
        from lint.fdm_html import fdm_to_html
...
class IzeMapTests(unittest.TestCase):
    def test_rpm_maps(self) -> None:
        from lint.ize_map import ize_command_for_lint, ize_targets_for_lint
    ...
    def test_posync_maps(self) -> None:
        from lint.ize_map import ize_targets_for_lint
...
class BrowseUiTests(unittest.TestCase):
    ...
    def test_docs_zh_cn_uses_locale_md(self) -> None:
        from lint.docs import clear_doc_cache, rule_doc_dict
