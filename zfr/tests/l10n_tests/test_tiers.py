...
from i18n.builder import opencc_convert, _which_opencc  # noqa: E402
...
class L10nTierTests(unittest.TestCase):
    ...
    def test_compile_derived_mo_skips_fresh(self) -> None:
        ...
        from i18n.builder import compile_derived_mo, derive_locales
