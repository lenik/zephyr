...
Version:        %{version}
Release:        1%{?dist}
Summary:        Perl CLI project template with example app
...
%description
zephyr is a Meson-based template for small Perl command-line utilities.
It ships the some_puff1 example script (Getopt::Long), AsciiDoc man pages,
