...
START_TEST(test_copy_file_missing) {
    ck_assert_int_eq(copy_file("some_puff1-test", "/definitely/not/found"), -1);
}
END_TEST

static Suite *some_puff1_suite(void) {
    Suite *s = suite_create("some_puff1");
